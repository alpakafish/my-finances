...
- Настройки: полная очистка данных (с подтверждением), защита приложения паролем/Touch ID и проверка обновлений (в приложении для Mac), версия приложения с копированием в буфер
