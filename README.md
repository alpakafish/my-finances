...
- Настройки: валюта отображения (12 вариантов на выбор — меняет только символ и формат, без пересчёта старых операций по курсу), полная очистка данных (с подтверждением), защита приложения паролем/Touch ID и проверка обновлений (в приложении для Mac), версия приложения с копированием в буфер
