...
Данные хранятся в `~/Library/Application Support/My Finances/` — это стандартное место для данных приложений на Mac, обновления приложения его не затрагивают. Когда выйдет новая версия, приложение спросит, скачать ли её, а после скачивания предложит перезапуститься и установить.
